...
{ return <Box key={index}
  ...
  <div className="cardata_amount">
     <p>GST</p>
    <p>SHS {Math.floor((price/100)*12)}</p>
  </div>
         <hr/>
         <div className='cardata_addhope'>
          ...
          <div className='cardata_addhope_text'>
            <p>Donate SHS 5000 Tick to Add Hope.</p>
            <p>Our goal is to Make Our Mukono people happy 👌😋.</p>
          </div>
          <div className='cardata_addhope_image'>
            <img src="add_hope.png" alt=""/>
          </div>
         </div>
            <Button sx={ { borderRadius: "22px",width:"180px",background:"red",color:"white",display:"flex",height:"44px",alignSelf:"center",fontSize:"12px",fontFamily:"Lato, sans-serif",fontWeight:1000,marginTop:"8%",display:"flex",justifyContent:"space-evenly" } } variant="contained" className='order_detail_button' ><p>Checkout</p> <p>SHS {price+Math.floor((price/100)*12)}</p></Button>
