...
<Navbar/>
  <OrderDetail/>
    <div className="sec1">
      ...
      <div className="four1">
       <h2 className="four2" data-testid="header-text">Mukono Offers</h2>
    ...
    <div className='five2'>
         <div className='five3'>
          ...
          <div  className="six1">
            ...
            <div className="seve3">
            <h4 className="seve4">1 Pc free Chicken Zinger on a cart value of SHS 39900 or above on first order. Only for registered users.</h4>
            <h5 className="seve5">1 Pc free Chicken Zinger on a cart value of SHS 39900 or above on first order. Only for registered users.</h5></div>
            <div className="seve6">
            ...
            <div className="seve3">
            <h4 className="seve4">1 Pc free Veg Zinger on a cart value of SHS 39900 or above on first order. Only for registered users</h4>
            <h5 className="seve5">1 Pc free Veg Zinger on a cart value of SHS 39900 or above on first order. Only for registered users</h5></div>
            <div className="seve6">
            <button className="seve7">View Details</button>
            <button className="seve8"><span className="seve9">Redeem</span></button></div></div>
            ...
            <div className="seve3">
            <h4 className="seve4">Add 2 Pc  Hot n Crispy Chicken @ just SHS 9900 on min cart value of SHS 49900 or more. Applicable on 2nd &amp; 3rd order for signed in user.</h4>
            <h5 className="seve5">Add 2 Pc  Hot n Crispy Chicken @ just SHS 9900 on min cart value of SHS 49900 or more. Applicable on 2nd &amp; 3rd order for signed in user.</h5></div>
            <div className="seve6">
            <button className="seve7">View Details</button>
            <button className="seve8"><span className="seve9">Redeem</span></button></div></div>
            ...
            <div className="seve3">
            <h4 className="seve4">Upto SHS 10000 off on min cart value of SHS 59900 or more . Applicable on 4th order onwards for signed in user.</h4>
            <h5 className="seve5">Upto SHS 10000 off on min cart value of SHS 59900 or more . Applicable on 4th order onwards for signed in user.</h5></div>
            <div className="seve6">
            <button className="seve7">View Details</button>
            <button className ="seve8"><span className="seve9">Redeem</span></button></div></div>
            </div>
